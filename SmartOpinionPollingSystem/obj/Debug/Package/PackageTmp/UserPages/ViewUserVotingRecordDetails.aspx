...
<link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css">
    ...
    <script>
      ...
      <p style="float:right;padding-right:15px">
            <asp:HyperLink runat="server" ID="hlnkUserDashBoard" ViewStateMode="Disabled" ForeColor="Blue" Text="User DashBoard"></asp:HyperLink> <
    ...
    <asp:Panel  runat="server" ID="pnlCurrentUserComments" Visible="false">
        ...
        <asp:Button ID="btnSaveUserComments" runat="server" Text="Post" style="margin-left:auto; display:block;" OnClick="btnSaveUserComments_Click" />
