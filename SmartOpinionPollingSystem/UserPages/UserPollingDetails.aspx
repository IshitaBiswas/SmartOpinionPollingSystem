...
<%--    <link href="../Scripts/NewJQGrid/Content/jquery.jqGrid/ui.jqgrid.css" rel="stylesheet" />
    ...
    <h2 class="main_header" style="text-align:center"> <asp:Label ID="lblPollingSummaryHeading" runat="server"></asp:Label> </h2>
   <table id="dataGrid">
    </table>
    ...
    <asp:Panel runat ="server" ID="pnlPendingVotingRecord" Visible="false">
        <h2 class="main_header" style="text-align:center">Pending Polling Summary - Current Polling Window</h2>
